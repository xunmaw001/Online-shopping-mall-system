...
public class XiaoshoutongjiController {
    ...
    public R page(@RequestParam Map<String, Object> params,XiaoshoutongjiEntity xiaoshoutongji, 
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date goumairiqistart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date goumairiqiend,
		HttpServletRequest request){

        EntityWrapper<XiaoshoutongjiEntity> ew = new EntityWrapper<XiaoshoutongjiEntity>();
                if(goumairiqistart!=null) ew.ge("goumairiqi", goumairiqistart);
                if(goumairiqiend!=null) ew.le("goumairiqi", goumairiqiend);
