<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="退货原因" prop="tuihuoyuanyin">
          <el-select v-model="ruleForm.tuihuoyuanyin" placeholder="请选择退货原因">
            <el-option
                v-for="(item,index) in tuihuoyuanyinOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="退货原因" prop="tuihuoyuanyin">
	      <el-input v-model="ruleForm.tuihuoyuanyin"
                placeholder="退货原因" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shangchuanpingzheng" label="上传凭证" prop="shangchuanpingzheng">
          <file-upload
          tip="点击上传上传凭证"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.shangchuanpingzheng?ruleForm.shangchuanpingzheng:''"
          @change="shangchuanpingzhengUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shangchuanpingzheng" label="上传凭证" prop="shangchuanpingzheng">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shangchuanpingzheng.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="退货方式" prop="tuihuofangshi">
          <el-select v-model="ruleForm.tuihuofangshi" placeholder="请选择退货方式">
            <el-option
                v-for="(item,index) in tuihuofangshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="退货方式" prop="tuihuofangshi">
	      <el-input v-model="ruleForm.tuihuofangshi"
                placeholder="退货方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
	...
	shhf : false,
      ...
      ruleForm: {
        ...
        shhf: '',
          ...
          tuihuoyuanyinOptions: [],
          tuihuofangshiOptions: [],
      rules: {
          dingdanbianhao: [
          ],
          shangpinmingcheng: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zongjine = true;
          ...
          if(o=='tuihuoyuanyin'){
            this.ruleForm.tuihuoyuanyin = obj[o];
	    this.ro.tuihuoyuanyin = true;
            continue;
          }
          if(o=='shangchuanpingzheng'){
            this.ruleForm.shangchuanpingzheng = obj[o];
	    this.ro.shangchuanpingzheng = true;
            continue;
          }
          if(o=='tuihuofangshi'){
            this.ruleForm.tuihuofangshi = obj[o];
	    this.ro.tuihuofangshi = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.shouji!=''&&json.shouji){
          ...
          this.$message.error(data.msg);
            ...
            this.tuihuoyuanyinOptions = "七天无理由,质量问题,与商品描述不符,其他".split(',')
            this.tuihuofangshiOptions = "上门取件,自行寄回".split(',')
    },
    // 下二随
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `tuihuoshenqing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tuihuoshenqingCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    shangchuanpingzhengUploadChange(fileUrls) {
	this.ruleForm.shangchuanpingzheng = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
